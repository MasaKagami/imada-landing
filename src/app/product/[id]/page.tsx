...
const products = [
    { id: 1, name: "Imada Seasons Safe Oil", image: "/imada-1.webp", 
        ...
        notes: "For general pain, apply on the affected area. To use for headaches and colds, apply a small amount to the nose, throat, or temples, and gently massage the area to allow the medicinal properties to penetrate the nerve center. Regular use helps promote clarity, refreshes the mind, and enhances overall well-being.", 
    ...
    { id: 3, name: "Imada Red Flower Oil", image: "/imada-3.webp", 
        ...
        notes: "For external use only. Apply the balm to the affected area.", 
    ...
    { id: 7, name: "Snake Porous Capsicum Plaster", image: "/imada-7.webp", 
        ...
        notes: "Cut each piece to the required size and apply it to the clean and dry affected area. Each application can last for 2-3 days. If necessary, reapply.", 
